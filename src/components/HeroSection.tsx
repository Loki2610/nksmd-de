                  ...
                  <DialogTrigger asChild>
                    <div className="relative h-full w-full" onClick={handleVideoClick}>
                      <video 
                        ...
                        preload="metadata" 
                        aria-label="Modernes Architekturprojekt - dreistöckiges Haus" 
                        data-lovable="video" 
                      ...
                      >
                        ...
                        <img src="/lovable-uploads/3ecc6a43-6bdc-4552-bb15-34687cbea489.png" alt="Modernes dreistöckiges Architekturprojekt" className="object-cover h-full w-full" data-lovable="fallback-image" />
                      </video>
                      
                      {/* Standbild-Overlay */}
                      {showPlayButton && (
                        <div className="absolute inset-0">
                          <img src="/lovable-uploads/3ecc6a43-6bdc-4552-bb15-34687cbea489.png" alt="Modernes dreistöckiges Architekturprojekt" className="object-cover h-full w-full" />
                        </div>
                      )}
                      ...
                      {showPlayButton && (
                        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center z-10">
                          <button 
                            ...
                            className="bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full p-4 md:p-6 transition-all duration-100 touch-manipulation"
                          >
                    ...
                    <div className="relative">
                      ...
                      <div className="relative aspect-video w-full">
                        ...
                        >
                          ...
                          {/* Fallback für Browser ohne Video-Support */}
                          <img src="/lovable-uploads/3ecc6a43-6bdc-4552-bb15-34687cbea489.png" alt="Modernes dreistöckiges Architekturprojekt" className="object-contain w-full h-full" />
                        </video>
                      </div>
                    </div>
                  </DialogContent>
