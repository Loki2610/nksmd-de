                ...
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                  <DialogTrigger asChild>
                    <div className="relative h-full w-full" onClick={handleVideoClick}>
                      ...
                      {showPlayButton && <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center z-10">
                          <button onClick={handlePlayButtonClick} aria-label="Video abspielen" className="bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full p-3 md:p-4 transition-all duration-100 touch-manipulation">
