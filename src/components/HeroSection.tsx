                ...
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                  ...
                  <DialogContent className="max-w-5xl w-full bg-black border-none p-0 [&>button]:hidden">
                    <div className="relative">
                      {/* Custom Close Button */}
                      <button onClick={() => setIsModalOpen(false)} aria-label="Video schließen" className="absolute -top-0 right-0 z-10 bg-opacity-80 hover:bg-opacity-100 p-2 transition-all duration-200 text-white bg-transparent rounded-none">
