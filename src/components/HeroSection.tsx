          ...
          <div className="order-2 lg:order-1">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-6 text-lg text-architect-muted max-w-2xl mx-auto lg:mx-0">
                Spezialisiert auf Planung und Genehmigungsmanagement für Bauunternehmen, Fertighaushersteller und Generalunternehmer. Mit über 5 Jahren Erfahrung und erfolgreichen Projekten in Deutschland und Österreich.
              </p>
